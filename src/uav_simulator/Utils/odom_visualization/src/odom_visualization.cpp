...
int main(int argc, char** argv)
{
  ...
  pose_pub = n.advertise<geometry_msgs::PoseStamped>("pose", 100, true);
  path_pub = n.advertise<nav_msgs::Path>("path", 100, true);
  vel_pub = n.advertise<visualization_msgs::Marker>("velocity", 100, true);
  cov_pub = n.advertise<visualization_msgs::Marker>("covariance", 100, true);
  cov_vel_pub = n.advertise<visualization_msgs::Marker>("covariance_velocity", 100, true);
  traj_pub = n.advertise<visualization_msgs::Marker>("trajectory", 100, true);
  sensor_pub = n.advertise<visualization_msgs::Marker>("sensor", 100, true);
  mesh_pub = n.advertise<visualization_msgs::Marker>("robot", 100, true);
  height_pub = n.advertise<sensor_msgs::Range>("height", 100, true);
